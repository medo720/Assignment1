...
//}
//
//void insert_beginning_array(struct student* arr)
//{
//    struct student w;
//    printf("Enter student name\n");
//    fflush(stdout);
...
//    scanf("%d", &(w.day));
//    n++;
//    realloc(arr, sizeof(struct student) * (n));
//    int i;
//    for (i = n - 1; i > 0; i--)
//    {
//        arr[i] = arr[i - 1];
...
//}
//
//void insert_end_array(struct student* arr)
//{
//    struct student w;
//    printf("Enter student name\n");
//    fflush(stdout);
...
//}
//
//void insert_middle_array(struct student* arr)
//{
//    int pos;
